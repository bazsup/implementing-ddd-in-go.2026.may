...
func TestCalculatePrice_ForABusinessCustomerFromPineville(t *testing.T) {
	...
	calculator := pricecalculation.NewPriceCalculator(getCustomer, emptyVisitHistory, noopSaveVisitHistory, domain.DefaultFractionPricingPolicy, noopPublishDomainEvent)
...
func TestCalculatePrice_WithAdditionalFeeFor3VisitsInOneMonth(t *testing.T) {
	...
	calculator := pricecalculation.NewPriceCalculator(getCustomer, getVisitHistory, noopSaveVisitHistory, domain.DefaultFractionPricingPolicy, noopPublishDomainEvent)
...
func TestCalculatePrice_ReturnsConcurrentModificationError(t *testing.T) {
	...
	calculator := pricecalculation.NewPriceCalculator(getCustomer, staleHistory, saveAlwaysConflicts, domain.DefaultFractionPricingPolicy, noopPublishDomainEvent)
...
var noopPublishDomainEvent = func(domain.DomainEvent) error { return nil }
