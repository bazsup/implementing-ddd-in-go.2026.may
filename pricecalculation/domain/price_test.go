...
func TestNewPrice_ValidPrice(t *testing.T) {
	price := domain.NewPriceFromUSDcents(735)
...
func TestPrice_Equals_SameAmount(t *testing.T) {
	a := domain.NewPriceFromUSDcents(735)
	b := domain.NewPriceFromUSDcents(735)
...
func TestPrice_Equals_DifferentAmount(t *testing.T) {
	a := domain.NewPriceFromUSDcents(735)
	b := domain.NewPriceFromUSDcents(100)

	assert.False(t, a.Equals(b))
}

func TestPrice_Add(t *testing.T) {
	a := domain.NewPriceFromUSDcents(150)
	b := domain.NewPriceFromUSDcents(585)
	sum := a.Add(b)
...
func TestPrice_Times(t *testing.T) {
	price := domain.NewPriceFromUSDcents(150)
